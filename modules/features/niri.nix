{ self, inputs, ... }: {
  ...
  perSystem =
    ...
    }:
    {
      ...
      # TODO: Change path below to remove "impurity"
      packages.myNiri = inputs.wrapper-modules.wrappers.niri.wrap {
        inherit pkgs;

        "config.kdl" = {
          path = /home/fabio/.config/niri/config.kdl;
        };
      };
...
#
#         # NOTE: This is the equivalent of MOD+Shift+Slash { show-hotkey-overlay; }
#
...
#             Mod+P hotkey-overlay-title="Snip" {spawn-sh "~#.local/bin/snip";}
